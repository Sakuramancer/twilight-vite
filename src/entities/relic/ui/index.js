...
export { ColorsHex } from "./relic-item-shared/ColorsHex";
export { PointHex } from "./relic-item-shared/PointHex";
export { FrameHex } from "./relic-item-shared/FrameHex";
export { RelicView } from "./relic-item-shared/RelicView";
